...
This document outlines security procedures and policies for the Wiki7 skin.
...
Instead, please report all vulnerabilities privately [through GitHub](https://github.com/StarWiki7Tools/mediawiki-skins-Wiki7/security/advisories/new).

You should receive a response within 24 hours. All coordination and disclosure are handled through the [GitHub advisory](https://github.com/StarWiki7Tools/mediawiki-skins-Wiki7/security).
