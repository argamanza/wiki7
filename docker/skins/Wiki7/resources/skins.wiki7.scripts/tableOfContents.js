...
const ACTIVE_SECTION_CLASS = 'wiki7-toc-list-item--active';
const EXPANDED_SECTION_CLASS = 'wiki7-toc-list-item--expanded';
const TOP_SECTION_CLASS = 'wiki7-toc-level-1';
const ACTIVE_TOP_SECTION_CLASS = 'wiki7-toc-level-1--active';
const LINK_CLASS = 'wiki7-toc-link';
const TOGGLE_CLASS = 'wiki7-toc-toggle';
const TOC_CONTENTS_ID = 'mw-panel-toc-list';
const INDICATOR_CLASS = 'wiki7-toc-indicator';
const COLLAPSE_ENABLED_CLASS = 'wiki7-toc--collapse-enabled';
 ...
 * @property {Section[]} array-sections
 * @property {boolean} wiki7-is-collapse-sections-enabled
 */
...
class TableOfContents {
	...
	reloadTableOfContents( sections ) {
		...
		const load = () => this.mw.loader.using( 'mediawiki.template.mustache' ).then( () => {
			...
			this.props.container.classList.toggle(
				...
				!!tocData[ 'wiki7-is-collapse-sections-enabled' ]
			);
	...
	getTableOfContentsData( sections ) {
		...
		return {
			...
			'wiki7-is-collapse-sections-enabled': tableOfContentsLevel1Sections.length > 3 && sections.length >= tableOfContentsConfig.Wiki7TableOfContentsCollapseAtCount
		};
	}
