<template>
	<div
		ref="galleryRef"
		class="wiki7-command-palette-gallery"
		role="listbox"
		tabindex="-1"
	>
		<template
		...
		>
			...
			<div
				...
				class="wiki7-command-palette-gallery__heading"
			>
				{{ $i18n( section.heading ).text() }}
			</div>
			<!-- eslint-enable mediawiki/msg-doc, mediawiki/no-vue-dynamic-i18n -->
			<div class="wiki7-command-palette-gallery__grid">
