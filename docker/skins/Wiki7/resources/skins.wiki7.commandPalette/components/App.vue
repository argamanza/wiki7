<template>
	<Transition name="wiki7-command-palette-backdrop">
		<div
			v-if="isOpen"
			class="wiki7-command-palette-backdrop"
			@click="close"></div>
	</Transition>
	<Transition
		name="wiki7-command-palette"
	...
	>
		...
		>
			...
			<div
				ref="bodyContainer"
				class="wiki7-command-palette__body"
			>
				<div
					ref="bodyViewport"
					class="wiki7-command-palette__body-viewport"
					:class="{
						'wiki7-command-palette__body-viewport--has-detail': viewportHasDetail,
						'wiki7-command-palette__body-viewport--uniform-type': uniformItemType
					}"
				>
					...
					></command-palette-help-view>
					<template v-else>
						<div class="wiki7-command-palette__results">
						...
						<Transition name="wiki7-command-palette-detail">
							<command-palette-detail-panel
								v-if="highlightedItemDetail"
								class="wiki7-command-palette__detail"
...
.wiki7-command-palette {
	...
	&[ data-palette-layout='gallery' ] {
		...
		.wiki7-command-palette__body-viewport--has-detail {
			@media ( min-width: @min-width-breakpoint-tablet ) {
				.wiki7-command-palette__results {
					flex: 3;
				}

				.wiki7-command-palette__detail {
					flex: 2;
				}
			}
		}
	...
	&__body-viewport {
		...
		&--uniform-type .wiki7-command-palette-list-item__metadata__item--type {
			display: none;
		}
	}
	...
	&__results {
		...
		.wiki7-command-palette__body-viewport--has-detail & {
			@media ( min-width: @min-width-breakpoint-tablet ) {
				...
				.wiki7-command-palette-list-item__metadata,
				.wiki7-command-palette-list-item__text__description,
				.wiki7-command-palette-list-item__text-inline__description {
					display: none;
				}
			}
		}
...
.wiki7-command-palette-enter-active {
	transition-timing-function: var( --transition-timing-function-ease-out );
	transition-duration: var( --transition-duration-medium );
	transition-property: clip-path, transform, opacity;
}

.wiki7-command-palette-leave-active {
	transition-timing-function: var( --transition-timing-function-ease-in );
	transition-duration: var( --transition-duration-base );
	transition-property: clip-path, transform, opacity;
}

.wiki7-command-palette-enter-from,
.wiki7-command-palette-leave-to {
	opacity: 0;
...
.wiki7-command-palette-enter-to,
.wiki7-command-palette-leave-from {
	opacity: 1;
...
.wiki7-command-palette-backdrop-enter-active {
	transition-timing-function: var( --transition-timing-function-ease-out );
	transition-duration: var( --transition-duration-medium );
	transition-property: opacity;
}

.wiki7-command-palette-backdrop-leave-active {
	transition-timing-function: var( --transition-timing-function-ease-in );
	transition-duration: var( --transition-duration-base );
	transition-property: opacity;
}

.wiki7-command-palette-backdrop-enter-from,
.wiki7-command-palette-backdrop-leave-to {
	opacity: 0;
}

// Detail panel slide-in
.wiki7-command-palette-detail-enter-active,
.wiki7-command-palette-detail-leave-active {
	transition-timing-function: var( --transition-timing-function-ease-out );
	transition-duration: var( --transition-duration-medium );
	transition-property: flex, opacity;
}

.wiki7-command-palette-detail-enter-from,
.wiki7-command-palette-detail-leave-to {
	flex: 0;
	opacity: 0;
}
</style>
