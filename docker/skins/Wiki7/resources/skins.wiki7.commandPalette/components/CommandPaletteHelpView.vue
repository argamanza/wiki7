<template>
	<div
		v-if="!activeMode"
		class="wiki7-command-palette-help wiki7-command-palette__results"
	>
	...
	>
		...
		<template #description>
			...
			<div
				class="wiki7-command-palette-help__long-description"
	...
	<command-palette-detail-panel
		...
		class="wiki7-command-palette-help wiki7-command-palette__detail"
...
function buildPairs( mode ) {
	...
	if ( Array.isArray( mode.triggers ) && mode.triggers.length > 0 ) {
		pairs.push( {
			key: 'triggers',
			label: mw
				.message( 'wiki7-command-palette-help-section-triggers' )
				.text()
		} );
	}
	if ( mode.help && mode.help.description ) {
		pairs.push( {
			key: 'description',
			label: mw
				.message( 'wiki7-command-palette-help-section-description' )
				.text()
		} );
	}
	return pairs;
