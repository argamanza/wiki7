<template>
	<component
		...
		class="wiki7-command-palette-gallery-item"
		:class="rootClasses"
		:data-type="type"
	...
	>
		...
		<command-palette-image
			class="wiki7-command-palette-gallery-item__thumbnail"
...
module.exports = exports = defineComponent( {
	...
	setup( props, { emit } ) {
		...
		const rootClasses = computed( () => ( {
			'wiki7-command-palette-gallery-item--active': props.active && props.highlighted,
			'wiki7-command-palette-gallery-item--highlighted': props.highlighted
		} ) );
...
.wiki7-command-palette-gallery-item {
	display: block;
	padding: 0;
	overflow: hidden;
	color: inherit;
