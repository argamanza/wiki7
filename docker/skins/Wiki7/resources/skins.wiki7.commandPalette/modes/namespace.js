...
function adaptNamespaceResult( nsResult ) {
	return {
		id: `wiki7-command-palette-item-namespace-${ nsResult.value }`,
...
module.exports = defineMode( {
	id: 'namespace',
	triggers: [ '/ns:', ':' ],
	label: mw.message( 'wiki7-command-palette-command-ns-label' ).text(),
	description: mw.message( 'wiki7-command-palette-command-ns-description' ).text(),
	placeholder: mw.message( 'wiki7-command-palette-mode-ns-placeholder' ).text(),
	...
	help: {
		description: 'wiki7-command-palette-mode-namespace-description-help'
	},
