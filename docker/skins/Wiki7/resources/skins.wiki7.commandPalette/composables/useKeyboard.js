...
const coreBindings = [
	// --- ACTION ZONE ---
	{
		...
		hint: { msgKey: 'wiki7-command-palette-keyhint-enter-select', kbd: '↵', order: 10 }
	},
	{
		id: 'action-prev',
		zone: 'action',
	...
	// focused index.
	{
		...
		handle: () => {},
		hint: { msgKey: 'wiki7-command-palette-keyhint-navigate', kbd: '↑↓', order: 30 }
	},
	{
	...
	},
	{
		...
		handle: () => {},
		hint: { msgKey: 'wiki7-command-palette-keyhint-return', kbd: '←', order: 20 }
	},
	{
		...
		when: () => true,
		handle: () => {},
		hint: { msgKey: 'wiki7-command-palette-keyhint-close', kbd: 'esc', order: 999 }
	},
	...
	},
	{
		...
		handle: () => {},
		hint: { msgKey: 'wiki7-command-palette-keyhint-navigate', kbd: '↑↓', order: 20 }
	},
	{
	...
	},
	{
		...
		hint: { msgKey: 'wiki7-command-palette-keyhint-enter-search', kbd: '↵', order: 10 }
	},
	...
	},
	{
		...
		handle: () => {},
		hint: { msgKey: 'wiki7-command-palette-keyhint-actions', kbd: '→', order: 30 }
	},
	...
	// footer hint, shown when the highlighted item declares a copyValue.
	{
		...
		handle: () => {},
		hint: { msgKey: 'wiki7-command-palette-detail-copy-action', kbd: COPY_KBD, order: 35 }
	},
	...
	},
	{
		...
		when: ( state ) => Boolean( state.onToggleHelp ) &&
			...
			state.tokens.length === 0,
		handle: () => {},
		hint: { msgKey: 'wiki7-command-palette-command-help-label', kbd: '?', order: 40 }
	},
	...
	},
	{
		...
		hint: { msgKey: 'wiki7-command-palette-keyhint-clear', kbd: 'esc', order: 999 }
	},
	{
		...
		hint: { msgKey: 'wiki7-command-palette-keyhint-exit', kbd: 'esc', order: 999 }
	},
	{
	...
	// --- INPUT ZONE: Backspace (3 disjoint cases) ---
	{
		...
		hint: { msgKey: 'wiki7-command-palette-keyhint-back', kbd: '⌫', order: 200 }
	},
	{
		...
		hint: { msgKey: 'wiki7-command-palette-keyhint-edit-token', kbd: '⌫', order: 200 }
	},
	{
		...
		hint: { msgKey: 'wiki7-command-palette-keyhint-select-token', kbd: '⌫', order: 200 }
	}
];
...
function useKeyboard( options ) {
	...
	function handleKeydown( event ) {
		...
		const isActionFocused = Boolean(
			...
			event.target.closest( '.wiki7-command-palette-list-item__action' )
		);
