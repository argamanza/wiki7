...
/**
 * Wiki7ComponentBodyContent component
 */
class Wiki7ComponentBodyContent implements Wiki7Component {
	 ...
	 */
	public const SECTION_CLASS = 'wiki7-section';
	...
	private function prepareHeading( Document $doc, Element $heading ): void {
		DOMCompat::getClassList( $heading )->add( 'wiki7-section-heading' );
		...
		$indicator->setAttribute( 'class', 'wiki7-section-indicator wiki7-ui-icon mw-ui-icon-wikimedia-collapse' );
	...
	private function createSectionBodyElement( Document $doc, int $sectionNumber ): Element {
		...
		$sectionBody->setAttribute( 'id', 'wiki7-section-' . $sectionNumber );
